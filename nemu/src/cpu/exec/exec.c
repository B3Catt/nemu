...
opcode_entry opcode_table [512] = {
  ...
  /* 0x50 */	EX(push), EX(push), EX(push), EX(push),
  /* 0x54 */	EX(push), EX(push), EX(push), EX(push),
  /* 0x58 */	EX(pop), EX(pop), EX(pop), EX(pop),
  /* 0x5c */	EX(pop), EX(pop), EX(pop), EX(pop),
  ...
  /* 0xcc */	EX(int_3), EMPTY, EMPTY, EMPTY,
